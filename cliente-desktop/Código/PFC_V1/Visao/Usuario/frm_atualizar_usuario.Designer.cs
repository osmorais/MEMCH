...
{
    partial class frm_atualizar_usuario
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.btn_atualizar_usuario = new System.Windows.Forms.Button();
			...
			this.gpb_cadastro_usuario.Controls.Add(this.btn_atualizar_usuario);
			...
			this.gpb_cadastro_usuario.Text = "Atualização de Usuário";
			// 
			// txb_confirmar_senha
			// 
			...
			this.lbl_senha_acesso.Size = new System.Drawing.Size(70, 13);
			this.lbl_senha_acesso.TabIndex = 20;
			this.lbl_senha_acesso.Text = "Nova Senha:";
			// 
			// txb_login_usuario
			// 
			...
			// txb_cpf_usuario
			// 
			this.txb_cpf_usuario.Location = new System.Drawing.Point(9, 85);
			...
			this.lbl_cpf_usuario.Location = new System.Drawing.Point(7, 68);
			...
			// 
			this.btn_atualizar_usuario.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.5F);
			this.btn_atualizar_usuario.Location = new System.Drawing.Point(222, 155);
			this.btn_atualizar_usuario.Margin = new System.Windows.Forms.Padding(2);
			this.btn_atualizar_usuario.Name = "btn_atualizar_usuario";
			this.btn_atualizar_usuario.Size = new System.Drawing.Size(58, 26);
			this.btn_atualizar_usuario.TabIndex = 11;
			this.btn_atualizar_usuario.Text = "Atualizar";
			this.btn_atualizar_usuario.UseVisualStyleBackColor = true;
			this.btn_atualizar_usuario.Click += new System.EventHandler(this.btn_atualizar_usuario_Click);
			// 
			// btn_sair_formulario
			// 
			this.btn_sair_formulario.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.5F);
			this.btn_sair_formulario.Location = new System.Drawing.Point(9, 155);
			...
			this.Load += new System.EventHandler(this.frm_atualizar_usuario_Load);
        ...
        private System.Windows.Forms.Button btn_atualizar_usuario;
